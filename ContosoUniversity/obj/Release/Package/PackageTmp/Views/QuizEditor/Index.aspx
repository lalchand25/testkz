 ...
 <tr>
   ...
   @ if (Model != null)
      ...
      <tr>
        ...
        <th><a href="javascript:OpenPopup('/mcImage/create/');" id='A4' runat='server' > <img src="../../siteImages/imgchoice1.png" border="0" alt="edit" style="width: 110px;height: 31px;" /></a></th>
        <th><a href="javascript:OpenPopup('/mc/create/');" id='A5' runat='server' > <img src="../../siteImages/mc.png" border="0" alt="edit" style="width: 110px;height: 31px;" /></a></th>
