...
$(function() {
 ...
 <form  method="post" id="createProp" runat="server">
    @using (Html.BeginForm())
       {
        ...
        <b style="text-align: left"> Upload Type </b>
        </div>
        ...
        <div class="editor-label" >
         ...
         <div class="editor-label">        <b>Slide Name</b> 
          ...
          <div class="editor-label">
               @Html.TextBoxFor(model => model.SlideDescription, new  { style="width:400px;" })
    ...
    <b>Description</b>   
     ...
     <div class="editor-label">
                 @Html.TextAreaFor(model => model.ImageDescription, new { style = "width:700px;height:250px" })
         ...
         <div id="div2" style="display:none;">
             <br />
               ...
               <div class="editor-label">
                  @Html.TextBoxFor(model => model.ImagePath, new { @readonly = "readonly" }) 
               <asp:FileUpload ID="FileUpload0" runat="server" class="multi" accept="png" /><br /> 
              Formats : png,jpg,gif,jpeg. 
                Maximum Size : 100kb  , Width 100px and Height 100 px  
                </div>
...
@--
    ...
    <b>Help</b>   
     ...
     <div class="editor-label">
                 @Html.TextAreaFor(model => model.HelpSlide, new { style = "width:700px;height:100px" })
    ...
    <b>References</b>   
     ...
     <div class="editor-label">
                 @Html.TextAreaFor(model => model.RefSlide, new { style = "width:700px;height:100px" })
             <b> @Html.ValidationMessageFor(model => model.RefSlide)</b>
                 </div>
    ...
    <b>Quick</b>   
     ...
     <div class="editor-label">
                 @Html.TextAreaFor(model => model.Quick, new { style = "width:700px;height:100px" })
             <b> @Html.ValidationMessageFor(model => model.Quick)</b>
                 </div>
    ...
    <b>Useful Tips</b>   
     ...
     <div class="editor-label">
                 @Html.TextAreaFor(model => model.UsefulTips, new { style = "width:700px;height:100px" })
             <b> @Html.ValidationMessageFor(model => model.UsefulTips)</b>
                 </div>
    ...
    <b>Questions</b>   
     ...
     <div class="editor-label">
                 @Html.TextAreaFor(model => model.Question, new { style = "width:700px;height:100px" })
             <b> @Html.ValidationMessageFor(model => model.Question)</b>
                 </div>
    ...
    <b>Quiz</b>   
     ...
     <div class="editor-label">
                 @Html.TextAreaFor(model => model.Quiz, new { style = "width:700px;height:100px" })
             <b> @Html.ValidationMessageFor(model => model.Quiz)</b>
                 </div>
      <br />--
