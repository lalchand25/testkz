<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/profileMaster.Master"
    Inherits="System.Web.Mvc.ViewPage<IEnumerable<go_eoffice_pms.Models.pms_TaskMaster>>" %>
...
$(function() {
    ...
    <table border="1" style="width: 100%" cellpadding="0" cellspacing="0">
        <tr>
            <td style="width: 90%">
                Select Module:
                <%=Html.DropDownList("moduleid", (SelectList)ViewData["modulelist"],"Select", new { title = "Select", maxlength = 150, style = "width: 140px;", onchange = "UpdateTaskList();" })%>
            </td>
            <td style="width: 10%" align="center">
                <img src="<%=Url.Content("~/Images/new.png")%>" border="0" alt="edit" style="width: 44px;
                    height: 44px;" />
                <br />
