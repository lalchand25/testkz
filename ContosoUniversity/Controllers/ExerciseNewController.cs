...
{
    public class ExerciseNewController : Controller
    {
        //
        // GET: /Subject/
        ...
        public ActionResult finalExm()
        {
            ...
            var model = (from m in db.tb_QuizTestMaster
                         from b in db.tb_SubjectMaster
                         where m.SubjectId == b.SubjectId && b.Publish == true
                         select new { ShortDescription = b.ShortDescription, SubjectName = b.SubjectName, SubjectId = b.SubjectId, AutoId =m.AutoId});

            if (Convert.ToInt32(Session["cateid"]) == 9 ) // student 
            {
                model = model.Where(x => x.SubjectId == classid);
            }
            string topcours = "";
            foreach (var item in model)
            {
                topcours += "  <div class='message-box'> <h2> " + item.SubjectName + "  </h2>";
                topcours += "<h4></h4>";
                topcours += "<p> " + item.ShortDescription + "</p> ";
                topcours += "<br />";
                topcours += "<a href='/testfinal/welcome/?subjectid=" + item.SubjectId + "&testid=" + item.AutoId + "' >Start Test </a>";
                topcours += "</div>";
            }
            ViewBag.couseList = topcours;
            return View();
        }
        ...
        public ActionResult Index()
        {
            ...
            foreach (var item in model)
            {
                ...
                strTable += "<td align='center' valign='top'><a href='javascript:OpenPopup(&#34;/Exercisenew/welcome/?testid=" + item.AutoId + "&#34;);' id='A2' runat='server' ><img src='../../SiteImages/test.png' border='0'   alt='Delete' style='width:50px;Height:50px;'/></a>";
            }
            ViewData["data"] = strTable;
            return View();
        }
        public ActionResult Welcome1(int id = 0)
        {
            Int32 TestId = 0;
            ...
            if (id == 0)
            {
                ...
                {
                    id = Convert.ToInt32(Session["TestLessonId"]);
            ...
            Session.Add("backtolesson", " <a href='/SlideShowNew/Index/" + id + "'> Back to Lesson </a>");
            ...
            {// new add by lcp 19/12/20015
                Session.Add("TestLessonId", id);
                Session.Add("CurrentTestID", id);
                TestId = id;
            }
            ...
            Session.Add("lessonName", model1.LessionHeading);
            // ViewBag.lessonName = model1.LessionHeading;
            ViewData["SubjectName"] = clsCommon.getSubjectName(Convert.ToInt32(model1.SubjectId));
            Session.Add("subjectname", ViewData["SubjectName"]);

            //  ViewData["ClassName"] = clsCommon.getClassNameProduct(Convert.ToInt32(model1.ClassId));
            ViewBag.subid = model1.SubjectId;
            ...
            if (total > 0)
            {
                ViewData["startbutton"] = "<a href='/Exercisenew/Startup/?LessonId=" + TestId + "' id='A2' runat='server' ><img src='../../SiteImages/start.png' border='0'   alt='Delete' style='width:50px;Height:50px;'/></a>";
            }
            else
            {
            ...
            if (Request.HttpMethod == "POST")
            {
                if (Request.Form["Question"] != null)
                {
                    ...
                    return RedirectToAction("Startup", "Exercisenew", new { qid = 0 });
                }
        ...
        public ActionResult startupfinal(int id)
        {
            try
            {
                Int32 Duration = 5;
                ...
                if (Session["UserTestIdSession"] != null)
                {
                    ...
                    {
                        return RedirectToAction("Results", "Exercisenew", new { qid = 0 });
                    }
                }
                ...
                if (id > 0)
                {
                    ...
                    strQuery = @"select top 1 a.* from tb_quizdetail a where a.SubjectId=" + id;
                ...
                if (results1.Count() == 0)
                {
                    return RedirectToAction("ResultsFinal", "Exercisenew", new { qid = 0 });
                }
                else
                {
        ...
        [HttpPost]
        public ActionResult startupfinal(Int16 id, tb_QuizDetail model)
        {
            ...
            return RedirectToAction("StartupResultFinal", "Exercisenew", new { ResultId = model2.AutoId, subid = id });
        ...
        public ActionResult Startup()
        {
            try
            {
                ...
                if (Session["TestLessonId"] != null)
                {
                    ...
                    //=======
                    var model1 = db.tb_LessionMaster.ToList().Where(x => x.LessionId == LessonId).Single();
                    ViewBag.lessonName = model1.LessionHeading;
                    ViewData["SubjectName"] = clsCommon.getSubjectName(Convert.ToInt32(model1.SubjectId));
        ...
        public ActionResult StartupResult()
        {
            try
            {
                ...
                if (model1.QuesTypeId != 5)
                {
                    ...
                    strTables += " <h3>Question:</h3>" + model1.Decription + "<br />";
                ...
                else
                {
                    ...
                    //  strTables += "<embed src='../../sounds/wrong.mp3' loop='false' autoplay='true' width='0' height='0'  > <embed>";
        ...
        public ActionResult StartupResultFinal()
        {
            try
            {
                Int32 ResultId = 0;
                ...
                {
                    ViewBag.subid = Convert.ToInt32(Request.QueryString["subid"]);
                }
                var model = db.tb_QuizResults.ToList().Where(x => x.AutoId == ResultId).Single();
                var model1 = db.tb_QuizDetail.ToList().Where(x => x.AutoId == model.QuestionId).Single();
        ...
        public ActionResult Startup(tb_QuizDetail model)
        {
            ...
            return RedirectToAction("StartupResult", "Exercisenew", new { ResultId = model2.AutoId });
        ...
        public ActionResult Results()
        {
            ...
            if (Session["UserTestIdSession"] != null)
            {
                ...
                if (totalc < 50)
                {
                    ...
                    ViewData["totalScrore"] = totalc.ToString() + "%" + " You are Fail please try again";
                }
                else
                {
                    ViewData["totalScrore"] = totalc.ToString() + "%" + " Congratulations you are pass!";
                }
                ...
                //if (Bricks == 1) { clearedStatus = "<span1>☆</span1>"; }
                //if (Bricks == 2) { clearedStatus = "<span1>☆</span1> <span1>☆</span1> "; }
                //if (Bricks == 3) { clearedStatus = "<span1>☆</span1> <span1>☆</span1> <span1>☆</span1> "; }
                //if (Bricks == 4) { clearedStatus = "<span1>☆</span1> <span1>☆</span1> <span1>☆</span1> <span1>☆</span1> "; }
                //if (Bricks == 5) { clearedStatus = "<span1>☆</span1> <span1>☆</span1> <span1>☆</span1> <span1>☆</span1> <span1>☆</span1>"; }

                if (Bricks == 1) { clearedStatus = "<img src='http://www.kzonline.org/images/star-1.png' />"; }
                if (Bricks == 2) { clearedStatus = "<img src='http://www.kzonline.org/images/star-2.png' />"; }
                if (Bricks == 3) { clearedStatus = "<img src='http://www.kzonline.org/images/star-3.png' />"; }
                if (Bricks == 4) { clearedStatus = "<img src='http://www.kzonline.org/images/star-4.png' />"; }
                if (Bricks == 5) { clearedStatus = "<img src='http://www.kzonline.org/images/star-5.png' />"; }
                ...
                if (starInfor.Count() > 0)
                {
                    ...
                    ViewData["graphics"] = "<img alt='Image' style='width:100%;' class='img-responsive' src='http://www.kzonline.org/uploads/" + starInfor1.ImagePath + "' />";
                }
                ...
                {
                    //  ViewData["startSlideShow"] = "<a href='/SlideShownew/IntroLesson/" + test.LessonID + "' id='A2' runat='server' ><img src='../../SiteImages/start.png' border='0'   alt='Delete' style='width:50px;Height:50px;'/></a>";

                    ViewData["startSlideShow"] = "<a href='/SlideShownew/Index/" + test.LessonID + "' style='border: medium none; background-color: #e8424e; border-radius: 5px; color: #fff; font-size: 16px; font-weight: 600; padding:10px 20px;  margin:0px; float:left;' >Start</a>";
                    ViewData["startQuiz"] = "<a href='/Exercisenew/Welcome1/?LessonId=" + test.LessonID + "' style='border: medium none; background-color: #e8424e; border-radius: 5px; color: #fff; font-size: 16px; font-weight: 600; padding:10px 20px;  margin:0px; float:left;'>Start </a>";
                }
                ...
                {
                    string parentemail = "";
                    var modelUser2 = db.tb_UserMaster.ToList().Where(x => x.UserId == modelUser.ParentId);
                    if (modelUser2.Count() > 0)
                    {
                        var modelUser1 = db.tb_UserMaster.ToList().Where(x => x.UserId == modelUser.ParentId).Single();
                        parentemail = modelUser1.EmailID;
                    }
                    ...
                    ProductDetail += " <br/> <br/> Quiz Status</b>";
                    ...
                    if (parentemail != "")
                    {
                        emailSystem.sendNewFormat(parentemail, item1.EmailSubject, desc);
                    }
                    ...
                    if (Convert.ToInt32(ViewData["total"]) >= 90)
                    {
                        ...
                        ProductDetail = "";
                        ProductDetail += "<br /> Class : <b>" + clsCommon.getSubjectName(Convert.ToInt32(test.SubjectId)) + "</b>";
                        // ProductDetail += "<br /> Class : <b>" + clsCommon.getClassNameProduct(Convert.ToInt32(test.ClassID)) + "</b>";
                        //  ProductDetail += "<br /> Unit: <b>" + clsCommon.getUnitName(Convert.ToInt32(test.UnitID)) + "</b>";
                        ProductDetail += "<br /> Lesson: <b>" + clsCommon.getLessonName(Convert.ToInt32(test.LessonID)) + "</b>";
        ...
        public ActionResult ResultsFinal()
        {
            string clearedStatus = "Un-Successfull";
            var model = db.tb_QuizResults.ToList().Where(m => m.TestId == Convert.ToInt32(Session["UserTestIdSession"]));
            var model1 = db.tb_QuizResults.ToList().Where(m => m.ActualAns == m.Answer && m.TestId == Convert.ToInt32(Session["UserTestIdSession"]));
        ...
        public String SetReportForParent(Int32 id)
        {
            ...
            foreach (var item in model)
            {
                ...
                {
                    strTables += "<tr><td colspan='2'> <img alt='Image' width='100px' height='50px' src='http://www.kzonline.org/uploads/" + model1.Decription + "' /></td></tr>";
                }

                if (item.Answer == item.ActualAns)
                {
                    strTables1 += "<tr><td colspan='2'><img alt='Image' width='181px' height='40px' src='http://www.kzonline.org/siteimages/right1.png' /></td></tr>";
                }
                else
                {
                    strTables1 += "<tr><td colspan='2'><img alt='Image' width='181px' height='40px' src='http://www.kzonline.org/siteimages/wrong1.png' /></td></tr>";
                }
                ...
                if (model1.QuesTypeId == 1 || model1.QuesTypeId == 2 || model1.QuesTypeId == 5)
                {
                    ...
                    if (model1.Check3 == true) { check3 = okIcon; }
                    if (model1.Check4 == true) { check4 = okIcon; }
                    strTables += "<tr><td><img alt='Image' width='32px' height='32px' src='http://www.kzonline.org/siteimages/" + check1 + "' /></td><td>" + model1.Ans1 + "</td></tr>";
                    strTables += "<tr><td><img alt='Image' width='32px' height='32px' src='http://www.kzonline.org/siteimages/" + check2 + "' /></td><td>" + model1.Ans2 + "</td></tr>";
                    strTables += "<tr><td><img alt='Image' width='32px' height='32px' src='http://www.kzonline.org/siteimages/" + check3 + "' /></td><td>" + model1.Ans3 + "</td></tr>";
                    strTables += "<tr><td><img alt='Image' width='32px' height='32px' src='http://www.kzonline.org/siteimages/" + check4 + "' /></td><td>" + model1.Ans4 + "</td></tr>";
                }
                ...
                if (model1.QuesTypeId == 4)
                {
                    ...
                    if (model1.Check3 == true) { check3 = okIcon; }
                    if (model1.Check4 == true) { check4 = okIcon; }
                    strTables += "<tr><td><img alt='Image' width='32px' height='32px' src='http://www.kzonline.org/siteimages/" + check1 + "' /></td><td><img alt='Image' width='100px' height='75px' src='http://www.kzonline.org/uploads/" + model1.Ans1 + "' /></td></tr>";
                    strTables += "<tr><td><img alt='Image' width='32px' height='32px' src='http://www.kzonline.org/siteimages/" + check2 + "' /></td><td><img alt='Image' width='100px' height='75px' src='http://www.kzonline.org/uploads/" + model1.Ans2 + "' /></td></tr>";
                    strTables += "<tr><td><img alt='Image' width='32px' height='32px' src='http://www.kzonline.org/siteimages/" + check3 + "' /></td><td><img alt='Image' width='100px' height='75px' src='http://www.kzonline.org/uploads/" + model1.Ans3 + "' /></td></tr>";
                    strTables += "<tr><td><img alt='Image' width='32px' height='32px' src='http://www.kzonline.org/siteimages/" + check4 + "' /></td><td><img alt='Image' width='100px' height='75px' src='http://www.kzonline.org/uploads/" + model1.Ans4 + "' /></td></tr>";
                }
                strTables += strTables1;
            }
            strTables += "</table>";
