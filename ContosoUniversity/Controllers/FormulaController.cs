...
namespace OLProject.Controllers
{
    public class FormulaController : Controller
    {
        ...
        {
            var Llist = (from m in db.tb_Formula 
        ...
        private Boolean ValidateData(tb_Formula model)
        {
        ...
        [ValidateInput(false)]
        public ActionResult Create(tb_Formula model, Int32 id)
        {
            ViewData["buttonname"] = 1;
            try
            {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var model = (from m in db.tb_Formula
                         where m.AutoId == id
                         select m).Single();
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Edit(int id, tb_Formula model)
        {
            try
            {
                ViewData["buttonname"] = 2;
        ...
        public ActionResult Delete(int id)
        {
            ...
            var tb = (from m in db.tb_Formula
                      where m.AutoId == id
                      select m).Single();
            return View(tb);
        }
