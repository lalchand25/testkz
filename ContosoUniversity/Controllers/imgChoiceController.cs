...
{
    public class imgChoiceController : Controller
    {
        //
        // GET: /Subject/
        ...
        public ActionResult Index()
        {
            ...
            var model = db.tb_QuizDetail.ToList().Where(x => x.QuesTypeId == 4 && x.SlideId == SlideId);
...
//                    strTable += "<td align='center' valign='top'><a href='javascript:OpenPopup1(&#34;/truefalse/Delete/" + item.AutoId + "&#34;);' id='A2' runat='server' ><img src='../../SiteImages/Delete.png' border='0'   alt='Image' style='width:50px;Height:50px;'/></a></td>";
        ...
        private string getButton(Int32 SlideId, Int32 Buttonid)
        {
            ...
            if (SlideId > 0)
            {
                ...
                if (Buttonid == 1 || Buttonid == 2 || Buttonid == 3 || Buttonid == 4 || Buttonid == 8 || Buttonid == 21 || Buttonid == 22 || Buttonid == 23 || Buttonid == 24 || Buttonid == 25 || Buttonid == 26)
                {
                    if (Buttonid == 1)
                    {
                        result = "<a  style='float:right;' class='btn-grey' href='javascript:OpenPopup1(&#34;/imgChoice/popupHelp/" + SlideId + "?buttonid=" + Buttonid + "&#34;,&#34;Browser" + Buttonid.ToString() + "&#34;);' /><img  width='60px' height='60px' src='../../uploads/" + model.ImagePath + "' /><br />" + model.ButtonName + "</a>";
                    }
                    else if (Buttonid == 3)
                    {
                        result = "<a  style='float:right;' class='btn-grey' href='javascript:OpenPopup1(&#34;/imgChoice/popupUsefulTips/" + SlideId + "?buttonid=" + Buttonid + "&#34;,&#34;Browser" + Buttonid.ToString() + "&#34;);' /><img  width='60px' height='60px' src='../../uploads/" + model.ImagePath + "' /><br />" + model.ButtonName + "</a>";
                    }
                    else if (Buttonid == 2)
                    {
                        result = "<a  style='float:right;' class='btn-grey' href='javascript:OpenPopup1(&#34;/imgChoice/popupSolution/" + SlideId + "?buttonid=" + Buttonid + "&#34;,&#34;Browser" + Buttonid.ToString() + "&#34;);' /><img  width='60px' height='60px' src='../../uploads/" + model.ImagePath + "' /><br />" + model.ButtonName + "</a>";
                    }
                    else if (Buttonid == 4)
                    {
                        result = "<a  style='float:right;' class='btn-grey' href='javascript:OpenPopup1(&#34;/imgChoice/popupQuestion/" + SlideId + "?buttonid=" + Buttonid + "&#34;,&#34;Browser" + Buttonid.ToString() + "&#34;);' /><img  width='60px' height='60px' src='../../uploads/" + model.ImagePath + "' /><br />" + model.ButtonName + "</a>";
                    }
                    else if (Buttonid == 8)
                    {
                        result = "<a  style='float:right;' class='btn-grey' href='javascript:OpenPopup1(&#34;/imgChoice/popupFormula/" + SlideId + "?buttonid=" + Buttonid + "&#34;,&#34;Browser" + Buttonid.ToString() + "&#34;);' /><img  width='60px' height='60px' src='../../uploads/" + model.ImagePath + "' /><br />" + model.ButtonName + "</a>";
                    }
                    else if (Buttonid == 21)
                    {
                        result = "<a  style='float:right;' class='btn-grey' href='javascript:OpenPopup1(&#34;/imgChoice/popupTutorial/" + SlideId + "?buttonid=" + Buttonid + "&#34;,&#34;Browser" + Buttonid.ToString() + "&#34;);' /><img  width='60px' height='60px' src='../../uploads/" + model.ImagePath + "' /><br />" + model.ButtonName + "</a>";
                    }
                    else if (Buttonid == 22)
                    {
                        result = "<a  style='float:right;' class='btn-grey' href='javascript:OpenPopup1(&#34;/imgChoice/popupview/" + SlideId + "?buttonid=" + Buttonid + "&#34;,&#34;Browser" + Buttonid.ToString() + "&#34;);' /><img  width='60px' height='60px' src='../../uploads/" + model.ImagePath + "' /><br />" + model.ButtonName + "</a>";
                    }
                    else if (Buttonid == 23)
                    {
        ...
        private Boolean ValidateData(tb_QuizDetail model)
        {
            ...
            if (model.ActualAns == null)
                ViewData.ModelState.AddModelError("ActualAns", "Please select ");
            ...
            try
            {
                ...
                string filename4 = "";
                    ...
                    if (file.ContentLength < 2000000)
                    {
                        ...
                        {
                            string randName = emailSystem.CreateRandomPassword(8);
                            filename2 = randName + "_" + file1.FileName;
                    ...
                    if (file.ContentLength < 2000000)
                    {
                        ...
                        {
                            string randName = emailSystem.CreateRandomPassword(8);
                            filename3 = randName + "_" + file2.FileName;
                    ...
                    if (file.ContentLength < 2000000)
                    {
                        ...
                        {
                            string randName = emailSystem.CreateRandomPassword(8);
                            filename4 = randName + "_" + file3.FileName;
                    ...
                    if (filename1 != "") { model.Ans1 = filename1; }
                    if (filename2 != "") { model.Ans2 = filename2; }
                    if (filename3 != "") { model.Ans3 = filename3; }
                    if (filename4 != "") { model.Ans4 = filename4; }
                    ...
                    if (ValidateData(model) && SlideId > 0)
                    {
                        ...
                        if (model.ActualAns == 1) { model.Check1 = true; }
                        if (model.ActualAns == 2) { model.Check2 = true; }
                        if (model.ActualAns == 3) { model.Check3 = true; }
                        if (model.ActualAns == 4) { model.Check4 = true; }
                        model.NoneOfAbove = "";
                        model.AllOfAbove = "";
                        model.Ans5 = "";
                        model.Ans6 = "";
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewData["Image1"] = model.Ans1;
            ViewData["Image2"] = model.Ans2;
            ViewData["Image3"] = model.Ans3;
            ViewData["Image4"] = model.Ans4;
        ...
        public ActionResult Edit(int id, tb_QuizDetail model)
        {
            try
            {
                ...
                var model1 = (from m in db.tb_QuizDetail
                    ...
                    HttpPostedFileBase file1 = Request.Files[1];
                    if (file1.ContentLength < 2000000)
                    {
                        String FileExtension = Path.GetExtension(file1.FileName).ToLower();
                        if (FileExtension == ".png" || FileExtension == ".jpg" || FileExtension == ".jpeg" || FileExtension == ".gif")
                        {
                    ...
                    HttpPostedFileBase file3 = Request.Files[3];
                    if (file3.ContentLength < 2000000)
                    {
                        String FileExtension = Path.GetExtension(file3.FileName).ToLower();
                        if (FileExtension == ".png" || FileExtension == ".jpg" || FileExtension == ".jpeg" || FileExtension == ".gif")
                        {
                    ...
                    if (filename1 != "") { model1.Ans1 = filename1; }
                    if (filename2 != "") { model1.Ans2 = filename2; }
                    if (filename3 != "") { model1.Ans3 = filename3; }
                    if (filename4 != "") { model1.Ans4 = filename4; }
                    ...
                    if (ValidateData(model))
                    {
                        ...
                        if (model.ActualAns == 1) { model1.Check1 = true; }
                        if (model.ActualAns == 2) { model1.Check2 = true; }
                        if (model.ActualAns == 3) { model1.Check3 = true; }
                        if (model.ActualAns == 4) { model1.Check4 = true; }
