...
namespace OLProject.Controllers
{
    public class QuestionController : Controller
    {
        ...
        {
            var Llist = (from m in db.tb_Question
        ...
        private Boolean ValidateData(tb_Question model)
        {
        ...
        [ValidateInput(false)]
        public ActionResult Create(tb_Question model, Int32 id)
        {
            ViewData["buttonname"] = 1;
            try
            {
                ...
                if (Request.HttpMethod == "POST")
                {
                    if (ValidateData(model))
                    {
                        ...
                        ProductDetail += "<br /> Image Description<br /><img src='http://www.goonlineschool.com/uploads/" + model.ImagePath + "' border='0'   alt='Delete' style='width:50px;Height:50px;'/> ";
        ...
        public ActionResult Edit(int id)
        {
            ...
            var model = (from m in db.tb_Question
                         where m.AutoId == id
                         select m).Single();
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Edit(int id, tb_Question model)
        {
            try
            {
                ViewData["buttonname"] = 2;
        ...
        public ActionResult Delete(int id)
        {
            ...
            var tb = (from m in db.tb_Question
                      where m.AutoId == id
                      select m).Single();
            return View(tb);
        }
