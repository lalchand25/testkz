...
namespace OLProject.Controllers
{
    public class SolutionController : Controller
    {
        ...
        {
            var Llist = (from m in db.tb_Solution 
        ...
        private Boolean ValidateData(tb_Solution model)
        {
        ...
        [ValidateInput(false)]
        public ActionResult Create(tb_Solution model, Int32 id)
        {
            ViewData["buttonname"] = 1;
            try
            {
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Edit(int id, tb_Solution model)
        {
            try
            {
                ViewData["buttonname"] = 2;
        ...
        public ActionResult Delete(int id)
        {
            ...
            var tb = (from m in db.tb_Solution
                      where m.AutoId == id
                      select m).Single();
            return View(tb);
        }
