...
namespace OLProject.Controllers
{
    public class FamilyUserController : Controller
    {
        ...
        {
            Session.Add("ModuleName0", "Family User Information");
            ...
            if (model1.PackageId > 0)
            {
                ...
                {
                    ViewData["links"] = "<a href='javascript:OpenPopup(&#34;/FamilyUser/create/&#34;);' id='contract' runat='server' ><img src='../../siteImages/create.png' border='0' alt='edit' style='width: 50px;height: 50px;' /></a>";
                }
            }
            return View();
        }
        ...
        private Boolean validateRegisterData(string emailid, string password, string confirmPassword, tb_UserMaster model)
        {
            ...
            {
                ViewData.ModelState.AddModelError("ClassId", "Please Select ClassId !");
            }
                ...
                if (model1.PackageId > 0)
                {
                    ...
                    if (Request.HttpMethod == "POST")
                    {
                        ...
                        if (validateRegisterData(emailid, password, ConfirmPassword, model) == true)
                        {
                            ...
                            Int32 userid = Convert.ToInt32(model.UserId);
                            ...
                            String strbody = "Name: " + model.ProfileName + "<br />Categoryid:" + model90.category + "<br /><br /><a href='http://www.goonlineschool.com/login/confirm/" + userid + "'>Click here for Confirmation</a> ";
                            ...
                            desc = desc.Replace("DearClient", "Dear " + model.ProfileName + " <br /> Email : " + model.EmailID);
