...
namespace OLProject.Controllers
{
    public class HelpController : Controller
    {
        ...
        {
            var Llist = (from m in db.tb_Help 
        ...
        private Boolean ValidateData(tb_Help model)
        {
        ...
        [ValidateInput(false)]
        public ActionResult Create(tb_Help model, Int32 id)
        {
            ViewData["buttonname"] = 1;
            try
            {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var model = (from m in db.tb_Help
                         where m.AutoId == id
                         select m).Single();
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Edit(int id, tb_Help model)
        {
            try
            {
                ViewData["buttonname"] = 2;
